  ...
  public LBaseObject
{
  ...
  protected:
    ...
    bool m_isStun = false; ///< Is stuned (can not move).
    bool m_isPulse = false;
    bool m_isPlayer = false;
    bool m_isKnight = false; ///< Is a knight
  ...
  public:
    ...
    const bool isPulse() const; ///< Is a pulse
    const bool isKnight() const; ///< Is a knight.
    const bool isDoor()   const; ///< Is a door.
    const bool isSwitch() const; ///< Is a switch
    virtual void press(); ///< these are so the object manager can call them for the buttons
    virtual void unPress(); ///< these are so the object manager can call them for the buttons
}; //CObject
